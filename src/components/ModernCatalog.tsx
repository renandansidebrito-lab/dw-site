...
const MaterialCard = ({ 
  ...
  return (
    <motion.div
      ...
      className="group relative h-[280px] lg:h-[320px] w-full rounded-sm overflow-hidden cursor-pointer shadow-sm hover:shadow-lg transition-all duration-500 bg-slate-900"
    >
      <ModernImage
        src={material.imagem}
        alt={material.nome}
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 flex flex-col justify-end p-5">
        ...
        <div className="hidden md:block overflow-hidden transition-all duration-500 max-h-0 opacity-0 group-hover:max-h-32 group-hover:opacity-100 group-hover:mt-3">
          ...
          <div className="flex items-center text-white/90 font-medium text-xs uppercase tracking-wider group/btn">
            Ver detalhes <Eye className="ml-2 w-3.5 h-3.5 transition-transform group-hover/btn:translate-x-1" />
          </div>
        </div>
      </div>
    </motion.div>
          ...
          <div className="w-full md:w-[45%] flex flex-col h-[calc(90vh-300px)] md:h-full bg-white relative">
            ...
            <div className="p-6 md:p-10 overflow-y-auto custom-scrollbar flex-grow flex flex-col">
              <div className="mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-light text-slate-900 tracking-tight leading-none mb-6">
                  {material.nome}
                </h2>
              ...
              <div className="space-y-6 mt-auto">
                ...
                <div className="pt-6 border-t border-slate-100">
                  <span className="block text-slate-400 text-[9px] uppercase tracking-widest mb-3">Recomendado para</span>
    ...
    <div className="min-h-screen bg-slate-50 catalog-page">
      ...
      <section className="bg-slate-900 pt-28 pb-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img 
            ...
            alt="Galeria de materiais em rochas ornamentais"
            onError={(e) => {
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            Explore granitos, mármores, quartzitos e materiais especiais para chapas, bancadas e projetos sob medida.
          </motion.p>
        </div>
      </section>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:hidden flex items-center justify-between">
          <p className="text-slate-500 text-sm font-medium">{materiaisFiltrados.length} materiais</p>
          <button 
          ...
          >
            <Filter className="w-4 h-4" /> Filtrar materiais
          </button>
        </div>
        ...
        <aside className="hidden lg:block w-72 flex-shrink-0">
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm sticky top-24">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-slate-800 tracking-tight">Filtrar materiais</h2>
              {hasActiveFilters && (
            ...
            {/* Tipo de Pedra */}
            <div className="mb-6">
              <h3 className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-3">Tipo de Pedra</h3>
            ...
            {/* Cor */}
            <div className="mb-6">
              <h3 className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-3">Cor</h3>
            ...
            {/* Categoria Extra */}
            <div>
              <h3 className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-3">Características</h3>
              <div className="flex flex-wrap gap-2">
                {categories.map(c => (
                  <button 
                    key={c.value} 
            ...
            <>
              ...
              >
                <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                  <h2 className="text-lg font-bold text-slate-800">Filtrar materiais</h2>
                ...
                <div className="p-4 border-t border-slate-100 bg-white flex gap-3">
                  <button onClick={limparFiltros} className="flex-1 py-3 text-slate-600 font-semibold text-sm rounded-lg border border-slate-200">Limpar</button>
                  <button onClick={() => setMobileFiltersOpen(false)} className="flex-1 py-3 bg-brand text-white font-semibold text-sm rounded-lg shadow-md shadow-brand/20">Ver Resultados</button>
                </div>
              </motion.div>
            </>
          )}
        ...
        <main className="flex-1 pb-16 lg:pb-8">
          <div className="hidden lg:flex justify-between items-center mb-6">
            <p className="text-slate-500 text-sm font-medium">
              Mostrando <strong className="text-slate-900">{materiaisFiltrados.length}</strong> materiais
            </p>
