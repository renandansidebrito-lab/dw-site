...
const translations = {
  pt: {
    ...
    'home.process.step3.title': 'Curadoria',
    'home.process.step3.description': 'As chapas passam por processos de resinamento e polimentos',
  ...
  en: {
    ...
    'home.process.step3.title': 'Curation',
    ...
    'home.process.step5.description': 'Final finishing with high-quality finish',
  ...
  es: {
    ...
    'home.process.step3.title': 'Curación',
